...
export const metadata: Metadata = {
  title: 'Privacy · Stack Poker',
  description:
    'What Stack Poker collects (almost nothing) and where your data lives (your device).',
}
  ...
  return (
    <LegalPage title="Privacy" updated="July 2026">
      <Section title="The short version">
        <p>
          Stack Poker is built to need as little of your data as possible — which turns out to be
          almost none. No account, no personal data, no cross-site tracking, no cookies. We do count
      ...
      <Section title="What we store">
        <p>
          ...
          browser&rsquo;s local storage, on your device. It never reaches a server, because Stack
          Poker doesn&rsquo;t have one to send it to. Clear your browser data and it&rsquo;s gone;
          we keep no copy, because we never had one.
        </p>
      </Section>
      ...
      <Section title="What we count">
        <p>
          To know whether Stack Poker is any good — whether people find it, start playing, and come
          back — we keep a handful of anonymous, aggregate counts through{' '}
      ...
      <Section title="Children">
        <p>
          Stack Poker is play money, but it&rsquo;s still card play. It&rsquo;s meant for people 13
          and over.
        </p>
      </Section>
